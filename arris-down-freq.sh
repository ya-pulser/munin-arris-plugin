...
wget -q -O - $MODEM_URL | grep 'TR><TD>Downstream' | awk 'BEGIN{RS="R"} {print $0;}' | grep 'MHz' | sed 's/<\/TD><TD>/ /g;s/><TD>//g; s/<\/TD>//g; s/<T//g; s/Downstream /downfreq/' | awk ' { print $1 ".value",$2; }' | grep downfreq
