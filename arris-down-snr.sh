...
wget -q -O - $MODEM_URL | grep 'TR><TD>Downstream' | awk 'BEGIN{RS="R"} {print $0;}' | grep 'dB' | sed 's/<\/TD><TD>/ /g;s/><TD>//g; s/<\/TD>//g; s/<T//g; s/Downstream /downsnr/' | awk ' { print $1 ".value",$6; }' | grep downsnr
